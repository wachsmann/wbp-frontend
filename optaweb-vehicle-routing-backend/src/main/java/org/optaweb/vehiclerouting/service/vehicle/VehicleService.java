...
public class VehicleService {
    ...
    public void createVehicle(long plannerId,int capacity, String name) {
        ...
        Vehicle vehicle = vehicleRepository.createVehicle(capacity,name,plannerEntity);
        addVehicle(vehicle);
    }
    ...
    public void changeCapacity(long vehicleId, int capacity) {
        ...
        Vehicle updatedVehicle = VehicleFactory.createVehicle(vehicle.id(), vehicle.name(), capacity,vehicle.planner());
